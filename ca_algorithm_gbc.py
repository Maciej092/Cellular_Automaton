        ...
        for x in range(self.space_width):
            for y in range(self.space_width):
                if self.space_prev[x, y] == self.cell_empty:
                    if   self.check_rule_1(x, y):
                        continue
                    elif self.check_rule_2(x, y):
                        continue
                    elif self.check_rule_3(x, y):
                        continue
                    elif self.check_rule_4(x, y):
                        continue
                    else:
                        continue
