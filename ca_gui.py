...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_neighbourRule.setItemText(2, _translate("MainWindow", "HEXAGONAL_LEFT"))
        self.comboBox_neighbourRule.setItemText(3, _translate("MainWindow", "HEXAGONAL_RIGHT"))
        self.comboBox_neighbourRule.setItemText(4, _translate("MainWindow", "PENTAGONAL_LEFT"))
        self.comboBox_neighbourRule.setItemText(5, _translate("MainWindow", "PENTAGONAL_RIGHT"))
    ...
    def display_image(self):
        self.graphicsView.setImage(self._ca_algo.space.T, levels=(0.0,
                                   self._ca_algo.number_of_reserved_ids + float(
                                   self.lineEdit_randomGrain.text())))

    def generatePgColormap(self):
        self.pos = np.linspace(0.0, 1.0, self._ca_algo.number_of_reserved_ids+int(self.lineEdit_randomGrain.text()))
